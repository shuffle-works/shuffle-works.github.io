...
rg -F '<a href="/sparkforensics/vendor/spark-tuning-reference/landing.html">Open Spark Tuning Reference &rarr;</a>' "$page"
...
if rg -F '<a href="/sparkforensics/" target=' "$page" || \
  rg -F '<a href="/sparkforensics/vendor/spark-tuning-reference/landing.html" target=' "$page"; then
